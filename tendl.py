...
class Tendl:
    ...
    def tendlData(self, productZ, productA, isomerLevel=None, Elimit=60):
        ...
        if len(E)==0 or len(Cs)==0:
            ...
            "No TENDL data found for target: " + targetFoil + " for productZ" + productZ + "and product A: " + productA
        ...
        E, Cs = Tools().interpolate(x=E, y=CsSummed, xlimit=Elimit) # , xlimit=Elimit
